...
class CheckBookingByFaceWidget extends StatefulWidget {
  @override
  _CheckBookingByFaceWidgetState createState() => _CheckBookingByFaceWidgetState();
}

class _CheckBookingByFaceWidgetState extends State<CheckBookingByFaceWidget> {
  ...
  Future<void> sendNameToServer(String name) async {
    final nodeUrl = Uri.parse('http://10.0.2.2:3000/passBookingReserveByFace');
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed:(){
                        Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context)=>CheckBookingByFacePage())
                        );
                      },
